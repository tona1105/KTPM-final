<template>
    <!-- Food Item -->
      <div class="product-item">
        ...
        <div class="image">
          <a :href="geturl(listFoodnew.foodid)"><img :src="listFoodnew.foodimghp"  alt=""></a>
        </div>
        <div class="caption">
            <div class="price">
            <span class="price-new"><b>{{ listFoodnew.foodprice.toLocaleString() }} VNĐ</b></span>
          </div>
          <div class="name text-center">
            <a>{{ listFoodnew.foodname }}</a>
          </div>
          
          <div class="cart">
            <button type="button" class="btn btn-primary"><a :href="geturl(listFoodnew.foodid)" >  Xem ngay</a></button>
          </div>
        </div>
