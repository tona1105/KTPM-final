<template>
      ...
      <div class="row text-center">
        <div class="col-sm-4">
          <div class="contact-detail-box">
            ...
            <h4>Liên Hệ</h4>
            <abbr title="Phone">P:</abbr> 090 549 35 56<br>
            Fb <a href="https://www.facebook.com/nhahangtaidanangtochuctieccuoidanang" class="text-muted">Tiệm bánh </a>
          </div>
        </div><!-- end col -->
        ...
        <div class="col-sm-4">
          <div class="contact-detail-box">
            ...
            <address>
            456 Đường 02 tháng 09 <br>
            Khu Công viên bắc tượng đài  Hải Châu, Đà Nẵng<br>
          </address>
          </div>
        </div><!-- end col -->
        ...
        <div class="col-sm-4">
          <div class="contact-detail-box">
            ...
            <p >Đường dây nóng</p>
            <h4 class="text-muted"> 0905.493.556 - 0975.545.659</h4>
          </div>
        </div><!-- end col -->
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="contact-map">
            <img src="https://cdn.dealtoday.vn/img/s630x420/7fb436440ef84b9b9230068e558b1c24.jpg?sign=Ip5801fp-F8uRukpQqXhNQ" style="width: -webkit-fill-available;">
          </div>
        </div><!-- end col -->
        ...
        <div class="col-sm-6">
          ...
          <form role="form" name="ajax-form" id="ajax-form"   @submit.prevent="AddCustomerSP" method="post" class="form-main">
            ...
            <div class="form-group">
              <label for="name2" style="margin-right:40px">Tên</label>
              <ValidationProvider
              v-slot="{ errors }"
            ...
            <div class="form-group">
              <label for="email2" style="margin-right:25px">Email</label>
              <ValidationProvider
                        v-slot="{ errors }"
            ...
            <div class="form-group">
              <label for="message2" style="margin-right:12px">Lời nhắn</label>
              <ValidationProvider
                        v-slot="{ errors }"
                        rules="required"
                        name="Lời nhắn "    >
              ...
              class="form-control" id="message2" name="message" rows="5">Lời nhắn</textarea>
              <p class="muted text-danger">
                        {{ errors[0] }}
                        </p>
                    </ValidationProvider>
    ...
    padding: 10px 30px;" id="send " :disabled="invalid">Gửi</button>
...
export default {
 data(){
    ...
    methods:{
      async AddCustomerSP() {
      try {
      await Apidata.addCustomerSP(this.$axios, this.dataSubmit)
