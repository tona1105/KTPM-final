...
namespace CakeShop.ValidationTesting
{
    ...
    [TestClass]
    public class TestValidationContact
    {
        [TestMethod]
        public void Contact_TestMissingName()
        {
            ...
            var lstErrors = ValidateModel(add);
            Assert.IsTrue(lstErrors.Where(x => x.ErrorMessage.Contains("Vui lòng nhập Họ tên")).Count() > 0);
        }

        [TestMethod]
        public void Contact_TestMissingEmail()
        {
            Contact add = new Contact
            {
                Id = 1,
            ...
            var lstErrors = ValidateModel(add);
            Assert.IsTrue(lstErrors.Where(x => x.ErrorMessage.Contains("Vui lòng nhập Email")).Count() > 0);
        }

        [TestMethod]
        public void Contact_TestMissingDescription()
        {
            Contact add = new Contact
            {
                Id = 1,
            ...
            var lstErrors = ValidateModel(add);
            Assert.IsTrue(lstErrors.Where(x => x.ErrorMessage.Contains("Vui lòng nhập nội dung")).Count() > 0);
        }

        [TestMethod]
        [DataRow("Nguyen Van A")]
        //[DataRow("Banh kem @")]
        public void Contact_TestNameShouldCorrectFormat(string name)
        {
            Contact add = new Contact
            {
                Id = 1,
        ...
        //[DataRow("Nguyen Van A")]
        [DataRow("Banh kem @")]
        public void Contact_TestNameShouldNotCorrectFormat(string name)
        {
            Contact add = new Contact
            {
                Id = 1,
        ...
        [DataRow("email@email.com")]
        //[DataRow("email.com")]
        public void Contact_TestEmailShouldCorrectFormat(string email)
        {
            Contact add = new Contact
            {
                Id = 1,
        ...
        //[DataRow("email@email.com")]
        [DataRow("email.com")]
        public void Contact_TestEmailShouldNotCorrectFormat(string email)
        {
            Contact add = new Contact
            {
                Id = 1,
